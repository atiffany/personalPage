                ...
                <BrowserRouter>
                    <div onClick={this.toggle}>
                        ...
                        <div className = {this.state.toggled ? "Navigation--links__clicked" : "Navigation--links"}>
                            ...
                            <div className = "Navigation--links__item Navigation--links__item__clicked"><Link to="/">Projects</Link></div>                        
                            <div className = "Navigation--links__item Navigation--links__item__clicked"><Link to="/about">About Me</Link></div>
                            <div className = "Navigation--links__item Navigation--links__item__clicked"><Link to="/connect">Connect</Link></div>
                        </div>
                    </div>
                </BrowserRouter>
          </div>
